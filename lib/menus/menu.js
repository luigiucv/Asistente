...
[🛡️] ${prefix}nombre (+ nuevo nombre)
[🛡️] ${prefix}changename (+ nuevo nombre)
[🛡️] ${prefix}dewdesc (+ nueva descripción)
[🛡️] ${prefix}changedescripcion (+ nueva descripción)
[🛡️] ${prefix}grupo abrir / cerrar
...
||- *_-Cambiar Configuracion del Grupo-_*
[🛡️] ${prefix}nombre (+ nuevo nombre)
[🛡️] ${prefix}newnombre (+ nuevo nombre)
[🛡️] ${prefix}descripcion (+ nueva descripción)
[🛡️] ${prefix}newdesc (+ nueva descripción)
[🛡️] ${prefix}grupo abrir / cerrar`
