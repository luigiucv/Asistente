...
const bufferFakeReplyVor = fs.readFileSync('./media/imagen/vor.png')
...
exports.fakeStatusVor = async(from, text) => {
    const options = {
        contextInfo: {
            forwardingScore: 999,
            isForwarded: true,
            ...
            quotedMessage: {
                imageMessage: {
                    caption: 'єνα αѕιѕтαηт | 𝔏𝔲𝔠𝔥𝔦𝔱𝔬',
                    jpegThumbnail: bufferFakeReplyVor
                }
            }
        }
    }
