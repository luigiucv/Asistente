...
const getRegisteredRandomId = () => {
  ...
  Si te gusta los viajes, trekkin, campamentos, la aventuras y adrenalina con un presupuesto limitado, estas en el lugar correcto 🥳
  Somos un grupo de viajeros, realizamos salidas todos los fines de semana y feriados.
  Recuerda siempre seguir las reglas y mantener una formalidad respetuosa.
  🚫 *Está prohibido* 🚫
  ❌ Hacer SPAM
  ❌ Enviar sticker inadecuados(XXX) 
  ❌ Enviar fotos o videos(XXX)
  ❌ Enviar enlaces(sitios web, grupos, etc)
  
  🚨 *Recuerda* 🚨
  ✅ Solicitar info de itinerario solo a l@s admin
  ✅ Realizar reservas solo con l@s admin
